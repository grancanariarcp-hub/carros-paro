...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto bg-gray-50">
      {/* Header azul */}
      <div className="bg-blue-700 px-6 pt-16 pb-10 text-center">
        ...
        <h1 className="text-2xl font-bold text-white">Carros de paro</h1>
        <p className="text-blue-200 text-sm mt-1">Sistema de gestión hospitalaria</p>
      </div>
