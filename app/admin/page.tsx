    ...
    <div className="page">
      ...
      <div className="topbar" style={{borderBottom:`2px solid ${colorPrimario}20`}}>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button onClick={() => router.push('/buscar')} className="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 bg-white active:bg-gray-50" title="Buscar">
