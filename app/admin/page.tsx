...
export default function AdminPage() {
  ...
  async function aprobarUsuario(id: string, rol: string) {
              ...
              {pendientes.map(u => (
                <div key={u.id} className="row-item">
                  ...
                  <div className="flex gap-1">
                    <button className="btn-success" onClick={() => aprobarUsuario(u.id, u.rol)}>Aprobar</button>
          ...
          <div className="card">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                <button className="btn-primary" onClick={() => toast('Función disponible en versión completa')}>PDF</button>
                <button className="btn-secondary" onClick={() => toast('Función disponible en versión completa')}>Excel</button>
              </div>
            </div>
          </div>
        )}
